...
#define _sock_locks(x)						  \
  ...
  x "AF_QIPCRTR",	x "AF_SMC"	,	x "AF_RPMSG"    , \
  x "AF_MAX"
...
static const char *const af_family_rlock_key_strings[AF_MAX+1] = {
  ...
  "rlock-AF_QIPCRTR", "rlock-AF_SMC"     , "rlock-AF_RPMSG"    ,
  "rlock-AF_MAX"
};
static const char *const af_family_wlock_key_strings[AF_MAX+1] = {
  ...
  "wlock-AF_QIPCRTR", "wlock-AF_SMC"     , "wlock-AF_RPMSG"    ,
  "wlock-AF_MAX"
};
static const char *const af_family_elock_key_strings[AF_MAX+1] = {
  ...
  "elock-AF_QIPCRTR", "elock-AF_SMC"     , "elock-AF_RPMSG"    ,
  "elock-AF_MAX"
};
