...
bool hsr_prp_addr_is_self(struct hsr_prp_priv *hsr, unsigned char *addr);
...
void *hsr_prp_get_next_node(struct hsr_prp_priv *hsr, void *_pos,
			    unsigned char addr[ETH_ALEN]);

int hsr_prp_get_node_data(struct hsr_prp_priv *hsr,
